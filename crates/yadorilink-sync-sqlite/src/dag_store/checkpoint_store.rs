...
fn decode_verified_row(
    ...
    encoded: &[u8],
) -> Result<yadorilink_replica_domain::rebootstrap::Checkpoint, SyncSqliteError> {
    let checkpoint = yadorilink_replica_domain::rebootstrap::Checkpoint::decode(encoded)?;
...
pub(crate) fn validate_all(conn: &Connection) -> Result<(), SyncSqliteError> {
...
pub fn latest_checkpoint(
    conn: &Connection,
    group_id: &str,
) -> Result<Option<yadorilink_replica_domain::rebootstrap::Checkpoint>, SyncSqliteError> {
