...
//! through the real full daemon stack (directly-paired peer sessions
//! over loopback) -- complementary to `collision_matrix.rs`
...
struct TestDevice {
    ...
    // This file's scenarios all drive concurrent multi-device writes and
