...
//! actually holds a DIFFERENT device's content. This was a REAL,
//! CONFIRMED bug (~50% repro rate for the original 3-device simultaneous
//! case per prior investigation): the conflict-copy naming attributed a
//! copy's identity to whichever peer session happened to process it,
//! rather than the content's true origin device.
//!
