...
// other crates' tests, e.g. Production callers must provide an explicit
// implementation that carries an epoch and revalidates it; the closure
// shortcut is deliberately absent from normal builds.
