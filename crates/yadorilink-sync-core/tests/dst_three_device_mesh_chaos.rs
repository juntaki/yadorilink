...
/// runs a 90s periodic frontier audit (`DEFAULT_FULL_INDEX_RESYNC_INTERVAL`);
    ...
    for round in 0..ops_per_run {
        ...
        match kind {
            ...
            RoundKind::Race => {
                ...
                // (the version vector decides the conflict; this keeps the
...
fn run_in_madsim(seed: u64, ops_per_run: usize) -> Result<(), String> {
    ...
    // Generous margin above `FINAL_CONVERGENCE_BUDGET` (90s) plus rounds'
